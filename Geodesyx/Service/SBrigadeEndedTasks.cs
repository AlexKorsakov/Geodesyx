...
{
    public class SBrigadeEndedTasks : Service1, IBrigadeEndedTasks
    {
        public List<Models.DTO.VBrigadeEndedTasks> SelectAll()
        {
            var list = new List<Models.DTO.VBrigadeEndedTasks>();
            using (OracleConnection connection = new OracleConnection(Service1.CONNECTION_STRING))
            {
                ...
                if (oraReader.HasRows)
                    ...
                    {
                        var temp = new Models.DTO.VBrigadeEndedTasks();
        ...
        public List<Models.DTO.VBrigadeEndedTasks> SelectIn(List<int> task_ids)
        {
            var list = new List<Models.DTO.VBrigadeEndedTasks>();
            string values = "";
